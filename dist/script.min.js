...
var PollDetail = React.createClass({
	render : function() {
		...
		var graphs = [];
		var options = [];
		options.push(<option>-- Select your vote --</option>);
		var idx = 0;
		for (var key in data) {
			//building options
			options.push(<option>{key.toUpperCase()}</option>);
		...
		//building share link
		var twitterLink = "https://twitter.com/intent/tweet?related=freecodecamp&text=" + this.props.title + " Check out the vote result : ";
			...
			<div>
				...
				<div className="row">
					<div className="col-md-4">
						<select className="form-control voteDropdown">
						    {options}
						</select> 
