...
var PollDetail = React.createClass({
	render : function() {
		...
		//building share link
		var twitterLink = "https://twitter.com/intent/tweet?related=freecodecamp&text=HELLO+WORLD";

		return (
			<div>
				<ol className="breadcrumb">
					<li><a onClick={this.props.homebutton} href="#">Home</a></li>
				...
				<div className="row">
					<div className="col-md-4">
						<div className="dropdown pull-left">
							<button className="btn btn-default dropdown-toggle" type="button" id="pollOptions" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
								-- Make your vote --
								<span className="caret"></span>
							</button>
							<ul className="dropdown-menu" aria-labelledby="pollOptions">
						...
						<button className="buttonVote pull-left">Vote</button>
					...
					<div className="col-md-8">{graphs}</div>
				</div>
			</div>
		);
	}
...
var App = React.createClass({
	...
	render : function(){
		...
		if (this.state.currentPage == "home") {
			...
			return (
				<PollDetail data={dataset[selectedItem].result} homebutton={bound} title={dataset[selectedItem].title} description={dataset[selectedItem].description} />
			);
		}
