...
var PollDetail = React.createClass({
	render : function() {
		...
		var twitterLink = "https://twitter.com/intent/tweet?related=freecodecamp&text=" + this.props.title + " Check out the vote result : "+ urlArr.join("%23");
...
var App = React.createClass({
	...
	componentWillMount : function() {
		...
		if (currentPage == "home") {
			this.setState({dataset : dataset, currentPage : currentPage});	
		}
