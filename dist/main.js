	  ...
	  //--------------------------------*/
		...
		render: function render() {
			...
			if (this.state.currentPage == "home") {
				...
				return React.createElement(PollDetail, { index: selectedItem, homebutton: bound, dataset: dataset[selectedItem] });
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'col-md-4' },
						React.createElement(VoteForm, { index: this.props.index, options: options, dataset: this.props.dataset }),
						React.createElement('br', null),
						React.createElement(
							'a',
		...
		render: function render() {
			if (this.state.pagestate == "active") {
				...
				return React.createElement(
					...
					React.createElement(
						'select',
						{ disabled: true, className: 'form-control voteDropdown', ref: 'vote' },
						this.props.options
					),
					React.createElement(
						'button',
						{ disabled: true, type: 'submit', className: 'buttonVote pull-left' },
						'Vote'
					),
					React.createElement(
						'div',
